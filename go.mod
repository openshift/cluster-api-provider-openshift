module github.com/openshift/cluster-api-provider-openshift
...
require (
	...
	github.com/openshift/hypershift v0.1.12
...
replace (
	github.com/openshift/api => github.com/JoelSpeed/api v0.0.0-20230929110148-da79a0cb2d3e
